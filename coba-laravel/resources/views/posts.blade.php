...
@if ($posts->count())
<div class="card mb-3">
    <img src="https://unsplash.it/1200/400?{{ $posts[0]->category->name }}" class="card-img-top" alt="{{ $posts[0]->category->name }}">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                <img src="https://unsplash.it/500/400?{{ $post->category->name }}" class="card-img-top" alt="{{ $post->category->name }}">
                <div class="card-body">
